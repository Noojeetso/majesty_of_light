...
class App:
    ...
    def update_events(self):
        for event in pygame.event.get():
            if event.type == pygame.VIDEORESIZE:
                self.screen_properties.display = pygame.display.set_mode((event.w, event.h), pygame.RESIZABLE)
    ...
    def calculate_translation(self):
        self.translation.x = -self.screen_properties.get_window_x()
        self.translation.y = -self.screen_properties.get_window_y()
    ...
    def fill_screen_black(self):
        self.screen_properties.display.fill((0, 0, 0))

    def draw_background(self):
        self.screen_properties.display.blit(self.bkg, (self.translation.x, self.translation.y))
    ...
    def draw_sea(self):
        ...
        for x in range(0, self.screen_properties.width + step, step):
            ...
            y_1 = y_2
            pygame.draw.polygon(self.screen_properties.display, (50, 135, 220),
    ...
    def draw_boids(self):
        ...
        # boid_counter += 1
        self.quadtree.show(pygame, self.screen_properties.display,
    ...
    def draw_box(self):
        self.screen_properties.display.blit(self.box_1.image,
                                            self.box_1.rect.move(self.translation.x, self.translation.y))

    # TODO: draw API
    # def draw(self, texture: Texture, pos_x: int, pos_y: int):
    #     self.screen_properties.display.blit(texture.)
